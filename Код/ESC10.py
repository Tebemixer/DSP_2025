...
# ResNet-like CNN
def build_resnet(block, layers, num_classes=10):
...
if __name__ == '__main__':
    ...
    print(device)
    model = build_resnet(ResidualBlock, [2,2,2,2], num_classes=10).to(device)
    ...
    for epoch in range(epochs):
        ...
        if acc > best_acc:
            best_acc = acc
            torch.save(model.state_dict(), 'best_model_ECS10.pth')
